...
hE3p2sHas2s_36 = hE3p2sHas2s.ProjectionX("hE3p2sHas2s_36",1,1);
hE3p2sHas2s_72 = hE3p2sHas2s.ProjectionX("hE3p2sHas2s_72",2,2);
hE3p2sHas2s_108 = hE3p2sHas2s.ProjectionX("hE3p2sHas2s_108",3,3);
hE3p2sHas2s_144 = hE3p2sHas2s.ProjectionX("hE3p2sHas2s_144",4,4);
hE3p2sHas2s_180 = hE3p2sHas2s.ProjectionX("hE3p2sHas2s_180",5,5);
...
hE3p2s_36.SetLineColor(1)
hE3p2s_72.SetLineColor(2)
hE3p2s_108.SetLineColor(3)
hE3p2sHas2s_36.SetLineColor(4)
hE3p2sHas2s_72.SetLineColor(5)
hE3p2sHas2s_108.SetLineColor(6)

c2.cd(1)
gPad.SetLogy()
l1 = TLegend(0.8,0.99,0.8,0.99);
l1.AddEntry(hE3p2s_36,"3p2s 45 degrees","l");
hE3p2s_36.GetXaxis().SetRangeUser(1300,2200)
hE3p2s_36.Draw()
hE3p2s_72.Draw("SAME")
hE3p2s_108.Draw("SAME")
l1.Draw()
c2.cd(2)
gPad.SetLogy()
hE3p2sHas2s_36.GetXaxis().SetRangeUser(1300,2200)
hE3p2sHas2s_72.Draw()
hE3p2sHas2s_108.Draw("SAME")
hE3p2sHas2s_144.Draw("SAME")
c2.cd(3)
gPad.SetLogy()
hE3p2s_36.GetXaxis().SetRangeUser(1300,2200)
hE3p2sHas2s_36.Draw()
